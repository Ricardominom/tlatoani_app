      ...
      >
        ...
        >
          <Svg width={38} height={38} viewBox="0 0 48 48" fill="none">
            ...
            />
            <Path
              d="M24 16.5 a7.5 7.5 0 1 1 -0.01 0"
              fill="none"
              stroke="#E5297E"
              strokeWidth="5.4"
              strokeLinecap="round"
        ...
        >
          <Svg width={38} height={38} viewBox="0 0 48 48" fill="none">
            <Rect
              ...
              height="11"
              rx="3"
              fill={filtroActivo === "generales" ? "#fff" : "#2D2D2D"}
            />
            <Path
              d="M15 18 L33 9 Q36 9 36 12 L36 39 Q36 42 33 42 L15 33 Z"
              fill="#F5C800"
              stroke={filtroActivo === "generales" ? "#fff" : "#2D2D2D"}
              strokeWidth="2.4"
